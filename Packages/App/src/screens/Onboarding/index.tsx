		...
		<AnimatedComponent animation="FadeIn">
			...
			>
				<View className=" py-5 justify-center items-center">
					<View className="w-full px-4 py-2 sm:px-8 sm:py-4 flex-row justify-end">
						{currentIndex < slides.length - 1 && (
							<Text
								...
								className="font-quicksand-bold text-secondary-700 text-base sm:text-lg"
							>
								Skip
							</Text>
						)}
					...
					<View className="flex flex-col items-center justify-between px-4 py-2 sm:px-8 sm:py-4">
						...
						{currentIndex < slides.length - 1 ? (
							...
							>
								<Text className="font-quicksand-bold text-secondary-700 text-base sm:text-lg">
									Next
								</Text>
							</Button>
						) : (
							<View className="flex flex-row items-center justify-center gap-4">
								<LastSlideButton
									...
									className="bg-primary-50 border-2 border-accent-500 sm:border-4"
								/>
								<LastSlideButton
									text="Join Now"
									onPress={() => {
									...
									className="bg-accent-500 sm:bg-accent-700"
								/>
							</View>
						)}
					</View>
