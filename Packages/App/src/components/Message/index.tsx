...
const Message: React.FC<MessageProps> = ({ type, message, className }): React.JSX.Element => {
	return (
		<View className={`flex flex-row items-center justify-center w-full mt-5 ${className}`}>
			<View
